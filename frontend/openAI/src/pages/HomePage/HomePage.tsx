...
export default function HomePage() {
  ...
  async function getAnswerFromAI() {
    const response = await axios.post(
      "https://openaibackend-a4uj.onrender.com/api/postQuestion",
      { AiChat: userSmsInput }
    );
    const responseData = response.data.reply;
    return responseData;
  ...
  async function getMessages() {
    try {
      const response = await axios.get(
        "https://openaibackend-a4uj.onrender.com/api/messages"
      );
  ...
  async function handleDeleteSms() {
    try {
      const deleteChat = await axios.delete(
        "https://openaibackend-a4uj.onrender.com/api/deleteChat"
      );
      getMessages();
